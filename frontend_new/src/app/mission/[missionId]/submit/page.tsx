                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="pixel-title text-lg text-amber-300">
                      {careerId === 'data-analyst' ? '林澈｜数据山脉导师' : careerId === 'software-engineer' ? '许砚｜硅屿工程导师' : careerId === 'product-designer' ? '叶舟｜产品设计港导师' : '沈栖｜AI研究塔导师'}
                    </h3>
                    <p className="mt-1 text-sm text-slate-300">
                      {careerId === 'data-analyst' ? '数据山脉导师' : careerId === 'software-engineer' ? '硅屿工程导师' : careerId === 'product-designer' ? '产品设计港导师' : 'AI研究塔导师'}
                    </p>
